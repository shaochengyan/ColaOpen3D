...
"""
一些定制可视化的方法:
    - 两种可视化方法: 直接调用函数、创建可视化对象
    - 可定制
        - 旋转: 传入定时旋转函数 custom_draw_geometry_with_rotation
        - 键盘来控制: 传入回调函数 custom_draw_geometry_with_key_callback
        - 控制相机轨迹并获取图像、点云: custom_draw_geometry_with_camera_trajectory
"""
